...
GoodDock이 그 사이의 빈칸을 채웁니다. 화면 하나를 지정하면 Dock이 그곳에 머물고, Space는 원래대로 모니터별로 독립적으로 동작합니다.
...
- 작동 상태와 Dock 이동을 몇 번 막았는지 보여줍니다
...
다만 오픈소스는 아닙니다. 저작권자가 모든 권리를 보유하며 **수정과 재배포, 상업적 이용은 허용되지 않습니다.** 전체 조건은 [LICENSE](LICENSE)를 참고하세요.
